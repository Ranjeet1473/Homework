...
#In my words
print("----------------------------------")
print("The linear SVM works best when the data can be separated with a straight line, making it faster."
      "The RBF SVM is better for complex data with curved patterns but takes more time to train.")