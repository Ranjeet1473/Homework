...
print("------------------------------------------------------------------------")
print("The Gini criterion is faster and creates simpler trees, making it efficient for large datasets, "
      "while the Entropy criterion provides more detailed splits but can be slower and lead to deeper trees. "
      "Both methods usually give similar accuracy, so the best choice depends on the dataset and model performance.")